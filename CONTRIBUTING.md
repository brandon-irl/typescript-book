...
### More Gitbook Tips
* Links work best if they are relative (e.g. `./foo.md`) to the *current* file.
* For links within the same file (i.e. `#foo-bar` style links), it is best to click the heading on github to get what gitbook expects.
